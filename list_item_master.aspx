<%@ Page Title="List of Items" Language="C#" MasterPageFile="~/iwps.Master" AutoEventWireup="true" CodeBehind="list_item_master.aspx.cs" Inherits="IWPS.list_item_master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_maindiv" runat="server">
<div class="iwps-card">
    <div class="iwps-card-header">List of Items</div>
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-4">
                <asp:Label runat="server" CssClass="form-label-custom" Text="Filter by Category:"></asp:Label>
            ...
            <div class="col-md-3 d-flex align-items-end">
                <a href="item_master.aspx" class="btn btn-sm btn-iwps-primary">+ New Item</a>
            </div>
        </div>
        <asp:GridView ID="gvList" runat="server" CssClass="iwps-custom-grid" AutoGenerateColumns="false" Width="100%" GridLines="None">
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="Edit" Text="Edit" DataNavigateUrlFields="ITEM_CODE" DataNavigateUrlFormatString="~/item_master.aspx?id={0}" ControlStyle-CssClass="btn btn-xs btn-outline-primary" />
            </Columns>
