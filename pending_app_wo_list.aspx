<%@ Page Title="HOD Work Order Approval" Language="C#" MasterPageFile="~/iwps.Master" AutoEventWireup="true" CodeBehind="pending_app_wo_list.aspx.cs" Inherits="IWPS.pending_app_wo_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_maindiv" runat="server">
    <h3 class="page-title">HOD - Work Order Approval (Forwarded)</h3>

    <div class="grid-section">
        <asp:GridView ID="gvWo" runat="server" AutoGenerateColumns="false" CssClass="grid-table"
            OnRowCommand="gvWo_RowCommand" EmptyDataText="No forwarded work orders pending."
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Action">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbApprove" runat="server" CommandName="ApproveWo"
                            CommandArgument='<%# Eval("WO_NO") %>' CssClass="btn btn-sm btn-success me-1"
                            OnClientClick="return confirm('Approve this Work Order?');">Approve</asp:LinkButton>
